...
<body>
	...
	<header>
		<ul class="top">
			...
			<?php if(strpos(current_url(), 'transparencia') == FALSE): ?>
				<li><a href="http://www.peru.gob.pe/transparencia/pep_transparencia_lista_planes_frame.asp?id_entidad=13181&id_tema=1">
					<img style="margin-bottom: -8px;" src="http://www.inmp.gob.pe/trans.png" alt="Logo">
					</i> Portal de Transparencia Estándar</a></li>
				
				
				<li><span>|</span></li>
				<li><a href="http://www.inmp.gob.pe/formulario/form-inmp/index.html"><i class="fa fa-group"></i> Contáctenos</a></li>
				<li><span>|</span></li>
			...
			<nav id="menu">
			    <div class="wrap">
			      ...
			      <ul id="navbar" class="clearfix">
			        ...
			        <li><a href="http://www.inmp.gob.pe/noticias">
					<i class="fa fa-newspaper"></i>NOTICIAS</a></li>
			      </ul>
